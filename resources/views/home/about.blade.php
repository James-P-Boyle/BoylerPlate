<x-home-layout>
    <div class="bg-white dark:bg-gray-800 flex flex-col w-full h-full gap-2 justify-between p-6">

        <div class="w-full dark:bg-gray-800 bg-white shadow flex flex-col gap-2 p-6">
