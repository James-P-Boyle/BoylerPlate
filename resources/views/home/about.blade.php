<x-home-layout>
    ...
    <div class="bg-white dark:bg-gray-800 flex flex-col w-full gap-4 px-2 py-4 sm:py-6 sm:px-4 border ">
        ...
        <div class="flex flex-col gap-4">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas mattis est eu odio sagittis tristique. Vestibulum ut finibus leo. In hac habitasse platea dictumst.
